...
An [instance](https://blyzp.github.io/sign-up-form/) of the project [*Sign-up Form*](https://www.theodinproject.com/lessons/node-path-intermediate-html-and-css-sign-up-form) from the ***Full Stack JavaScript*** path of **The Odin Project**.
